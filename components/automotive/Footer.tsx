        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 text-center">
          ...
          <div className="flex flex-col items-center">
            ...
            <ul className="space-y-2 text-center">
              ...
              <li>
                <Link href="/models" className="text-white/60 hover:text-luxury-gold transition-colors text-sm">
                  Modèles
                </Link>
              </li>
              <li>
                <Link href="/brand" className="text-white/60 hover:text-luxury-gold transition-colors text-sm">
                  Marque
                </Link>
              </li>
              <li>
                <Link href="/contact" className="text-white/60 hover:text-luxury-gold transition-colors text-sm">
                  Contact
                </Link>
              </li>
            </ul>
